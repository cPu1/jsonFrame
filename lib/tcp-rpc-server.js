...
TcpJsonRpcServer.prototype = Object.create(JsonRpcServer.prototype);

TcpJsonRpcServer.prototype.init = function(options) {
	...
	this._rpcServer = net.createServer(function (socket) {
		...
		jsonTransformer.on('data', function (json) {
			 ...
			 * */
			if(Array.isArray(response)) console.log('server', response)
...
TcpJsonRpcServer.prototype.listen = function (port) {
