...
fn = TcpJsonRpcClient.prototype = Object.create(JsonRpcClient.prototype, {constructor: {value: TcpJsonRpcClient}});
...
fn.notify = function (method, params) {
	...
	if(params != null && !Array.isArray(params) && typeof params !== 'object') throw 'params must be absent, an array or an object';
