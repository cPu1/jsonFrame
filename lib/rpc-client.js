...
fn.batchBuilder = {
	...
	add: function (method, params) {
		...
		//Function.prototype.call isn't needed
		var request = this.rpc.buildRequest(method, params);
	...
	notify: function(method, params) {
		...
		this._batch.push(this.rpc._buildNotification(method, params));
		return this;
	},
	clear: function () {
		this._batch = [];
 ...
 * the response by the order in which request objects were sent
